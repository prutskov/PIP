...
// VideoEffects.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CVideoEffectsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CVideoEffectsApp

CVideoEffectsApp::CVideoEffectsApp()
{
...
// Единственный объект CVideoEffectsApp

CVideoEffectsApp theApp;


// Инициализация CVideoEffectsApp

BOOL CVideoEffectsApp::InitInstance()
{
